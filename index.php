...
<head>
    ...
    <title>HANIF COLECTION | CRUD</title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">HANIF COLECTION | CRUD</a>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="text-center fw-bold text-uppercase">Data Mahasiswa Mahasiswi Unisnu</h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold text-uppercase" id="detail">Detail Data Mahasiswa Mahasiswi</h5>
    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            <div class="col-md-6 my-2" id="about">
                ...
                <p>Aplikasi ini dikembangkan untuk menggampangkan data mahasiswa mahasiswi Unisnu</p>
                <p>Devoloper Muhammad hanif Khoirullah</p>
            </div>
            <div class="col-md-6 my-2 text-center link">
                ...
                <a href="https://www.instagram.com/bgzegran/" target="_blank"><i class="bi bi-instagram fs-3"></i></a>
                <a href=" " target="_blank"><i class="bi bi-twitter fs-3"></i></a>
            </div>
        </div>
    </div>
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class=" "></i> by <u style="color: #fff;">Muhammad Hanif Khoirullah</u></p>
    </footer>
    <!-- Close Footer -->
